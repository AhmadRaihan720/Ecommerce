                ...
                <div class="header__top__right">
                    ...
                    <div class="header__top__right__language">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/home')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">
                            <i class="fa fa-user"> Home </i></a>
                        </li>
                        
                        <li>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">
                            <i class="fa fa-user"> Log In </i></a>
                        </li>

                        <li>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="hero__item set-bg" data-setbg="<?php echo e(asset('storage/img/hero/banner.jpg')); ?>">
    ...
    <div class="container">
        <div class="row">
            <div class="categories__slider owl-carousel">
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="<?php echo e(asset('storage/img/categories/cat-1.jpg')); ?>">
                        <h5><a href="#">Router</a></h5>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="<?php echo e(asset('storage/img/categories/cat-2.jpg')); ?>">
                        <h5><a href="#">Wireless card</a></h5>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="<?php echo e(asset('storage/img/categories/cat-3.jpg')); ?>">
                        <h5><a href="#">Bridge</a></h5>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="<?php echo e(asset('storage/img/categories/cat-4.jpg')); ?>">
                        <h5><a href="#">Access Point</a></h5>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="categories__item set-bg" data-setbg="<?php echo e(asset('storage/img/categories/cat-5.jpg')); ?>">
            ...
            <div class="row featured__filter">
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('storage/img/featured/feature-1.jpg')); ?>">
                            <ul class="featured__item__pic__hover">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-heart"></i></a></li>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('storage/img/featured/feature-2.jpg')); ?>">
                            <ul class="featured__item__pic__hover">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-heart"></i></a></li>
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('storage/img/featured/feature-3.jpg')); ?>">
                            <ul class="featured__item__pic__hover">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-heart"></i></a></li>
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood oranges">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('storage/img/featured/feature-4.jpg')); ?>">
                            <ul class="featured__item__pic__hover">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-heart"></i></a></li>
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat vegetables">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('storage/img/featured/feature-5.jpg')); ?>">
                            <ul class="featured__item__pic__hover">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-heart"></i></a></li>
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fastfood">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('storage/img/featured/feature-6.jpg')); ?>">
                            <ul class="featured__item__pic__hover">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-heart"></i></a></li>
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fresh-meat vegetables">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('storage/img/featured/feature-7.jpg')); ?>">
                            <ul class="featured__item__pic__hover">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-heart"></i></a></li>
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood vegetables">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="<?php echo e(asset('storage/img/featured/feature-8.jpg')); ?>">
                            <ul class="featured__item__pic__hover">
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-heart"></i></a></li>
                                <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
...
</html><?php /**PATH C:\xampp\htdocs\Ecommerce\resources\views/welcome.blade.php ENDPATH**/ ?>